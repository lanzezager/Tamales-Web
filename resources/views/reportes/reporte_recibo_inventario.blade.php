...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
	...
	<body>
		<table class="table table-borderless" >
			...
			<tbody>
				<tr>
					<td class="align-middle" colspan="3"><h3 class="text-center ">Factura de Recibo de Inventario</h3></td>
					<td style="width: 25%">
							...
							<table class="table table-striped table-sm" id="tabla_productos_entrega">
								...
								<tbody>
									...
									@endforeach
										...
										<tr>
											<td colspan="4" class="text-right" style="border: solid; border-width: 0px 2px 2px 0px; border-color: rgb(120, 120, 120);">Efectivo Recibido</td>
										...
										<tr>
											<td colspan="4" class="text-right" style="border: solid; border-width: 0px 2px 2px 0px; border-color: rgb(120, 120, 120);">Valor Total Recibido</td>
